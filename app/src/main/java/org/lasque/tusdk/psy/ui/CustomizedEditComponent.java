 ...
 * 
 */
package org.lasque.tusdk.psy.ui;
 ...
 * @author Clear
 */
public class CustomizedEditComponent extends Base implements TuEditTurnAndCutFragmentDelegate
{
	/** 裁切组件自定义界面范例 */
	public CustomizedEditComponent()
	{
